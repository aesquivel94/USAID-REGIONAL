...
function_to_save <- function(station, Esc_all, path_out){
  ...
  # Creation of the data folder (where the results will be saved). 
  ifelse(dir.exists(glue::glue('{path_out}summary')) == FALSE, 
         dir.create(glue::glue('{path_out}summary')), 'ok')
  
  
  # Creation of the data folder (where the results will be saved). 
  ifelse(dir.exists(glue::glue('{path_out}validation')) == FALSE, 
         dir.create(glue::glue('{path_out}validation')), 'ok')
...
#---------------------------------------------------------------------------------#
#  ___     _                       _                _                       _     
# / __|   | |_    __ _      _ _   | |_      o O O  | |_     ___     ___    | |_   
# \__ \   |  _|  / _` |    | '_|  |  _|    o       |  _|   / -_)   (_-<    |  _|  
# |___/   _\__|  \__,_|   _|_|_   _\__|   TS__[O]  _\__|   \___|   /__/_   _\__|  
# _|"""""|_|"""""|_|"""""|_|"""""|_|"""""| {======|_|"""""|_|"""""|_|"""""|_|"""""| 
...
#  ___               _              _                       _     
# | __|   _ _     __| |     o O O  | |_     ___     ___    | |_   
# | _|   | ' \   / _` |    o       |  _|   / -_)   (_-<    |  _|  
# |___|  |_||_|  \__,_|   TS__[O]  _\__|   \___|   /__/_   _\__|  
# _|"""""|_|"""""|_|"""""| {======|_|"""""|_|"""""|_|"""""|_|"""""| 
