...
download_data_chirp <- function(ini.date, end.date, year_to, path_Chirp){
  ...
  tictoc::tic()
  # download.file(url = urls, destfile = path_Chirp_all)
...
# Testing this parth 
# data_d <- Cerete
# special_data <-  it's a tibble: tibble(lat, lon, year_to, month_to). 
